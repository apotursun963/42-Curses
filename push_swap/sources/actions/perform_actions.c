	...
	, int write_action)
{
	if (action_type == SWAP_A)
		...
		swap_b(stack_b, write_action);
	else if (action_type == PUSH_A)
		push_a(stack_b, stack_a, write_action);
	else if (action_type == PUSH_B)
		push_b(stack_a, stack_b, write_action);
	else if (action_type == ROTATE_A)
		rotate_a(stack_a, write_action);
	else if (action_type == ROTATE_B)
		rotate_b(stack_b, write_action);
	else if (action_type == REVERSE_ROTATE_A)
		reverse_rotate_a(stack_a, write_action);
	else if (action_type == REVERSE_ROTATE_B)
		reverse_rotate_b(stack_b, write_action);
}
