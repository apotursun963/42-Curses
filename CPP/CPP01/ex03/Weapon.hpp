...
public:
    ...
    // Fonksiyonun dönüş tipi, std::string tipindeki bir nesnenin sabit (const) referansıdır. Yani fonksiyon bir string döndürür, fakat bunu referans olarak döndürür ve bu string üzerinde değişiklik yapılamaz.
